...
class Orbit:
    ...
    def getTotalOrbits(self):
        if self.parent is None:
            return 0
        if self.total_orbits == 0:
            self.total_orbits = self.parent.getTotalOrbits() + 1
...
# print(getTotalNumberOfOrbits(test_input))

puzzle_input = """97W)B43
R63)RTM
19C)SHD
F85)8Z8
5D9)Z5T
...
print(getTotalNumberOfOrbits(puzzle_input))
