...
opcode_lengths = {'1': 4, '2': 4, '3': 2, '4': 2}
...
# TODO: Pass in instructions that are a list of integers
def intcode_computer_with_test(instructions: list, input: int) -> None:
    current_opcode = instructions[0]
    position = 0
    while current_opcode != 99:
        if current_opcode == 1:
        ...
        # TODO: Convert parameter modes to single op code
